...
- Add `near-workspaces` as a dev dependency in Cargo.toml: `near-workspaces = "0.14"` (or latest)
- Use `near_workspaces::sandbox().await?` for isolated testing
...
- Use `cargo near build` to compile the contract before tests
...
- [Workspaces-rs GitHub](https://github.com/near/near-workspaces-rs)
- [near-workspaces on crates.io](https://crates.io/crates/near-workspaces)
